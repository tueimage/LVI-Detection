...
from timm.data import myTransforms
...
def transforms_imagenet_train(
    ...
    if gaussian:
        secondary_tfl += [transforms.GaussianBlur((5, 9), (0.1, 5))]
    if affine:    
        secondary_tfl += [myTransforms.RandomAffineCV2(alpha=0.1)]
    ...
    if elastic:
        secondary_tfl += [transforms.ElasticTransform(alpha=50.0, sigma=5.0)]
    if rotation:
        secondary_tfl += [transforms.RandomRotation(degrees=(-90, 90))]
