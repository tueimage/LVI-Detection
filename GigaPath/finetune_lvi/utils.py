...
def get_loader(train_dataset, val_dataset, test_dataset, 
               ...
               batch_size=1, num_workers=6, seed=0, 
...
class EarlyStopping:
    ...
    def __init__(self, patience=20, stop_epoch=50, verbose=False):
        ...
        Args:
            ...
            verbose (bool): If True, prints a message for each validation metrci improvement. 
                            Default: False
        """
    ...
    def save_checkpoint(self, val_metric, model, ckpt_name):
        ...
        if self.verbose:
            print(f'Validation metric ({self.val_metric_:.6f} --> {val_metric:.6f}).  Saving model ...')
            print('\n')
        torch.save(model.state_dict(), ckpt_name)
        self.val_metric_ = val_metric